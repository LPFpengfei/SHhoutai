...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/Public/Css/lib/flat-ui.min.css">
    <link rel="stylesheet" type="text/css" href="/Public/Css/manage.css">
    <script type="text/javascript" src="/Public/Js/jquery.js"></script>
    <script src="/Public/Js/lib/require.js" data-main="/Public/Js/manage_main"></script>
                ...
                <div class="panel-body">
                    <ul class="nav nav-pills nav-stacked nav-option">
                        ...
                        <li class="<?php if(($tab == 6)): ?>active<?php endif; ?>" role="presentation">
                            <a href="<?php echo U('/Admin/Index/index/tab/6');?>">订单列表</a>
                        </li>
