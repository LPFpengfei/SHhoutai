...
<head>
    ...
    <link rel="shortcut icon" href="/Public/Img/Home/favicon.ico" />
    ...
    <link rel="stylesheet" href="/Public/Css/Home/line-icons.css">
    <link rel="stylesheet" href="/Public/Css/Home/font-awesome.min.css">
    <link rel="stylesheet" href="/Public/Css/Home/flexslider.css">
    <link rel="stylesheet" href="/Public/Css/Home/jquery.bxslider.css">
    <link rel="stylesheet" href="/Public/Css/Home/horizontal-parallax.css">

    <!-- CSS Theme -->
    <link rel="stylesheet" href="/Public/Css/Home/default.css" id="style_color">

    <!-- CSS Customization -->
    <link rel="stylesheet" href="/Public/Css/Home/custom.css">
...
<div style="display:none;">
    <img src="/Public/Img/Home/ic_launcher.png" onerror="javascript:this.src='http://o1wjx1evz.qnssl.com/static-20160507/assets/img/default-icon.png';" />
</div>
<!--=== Breadcrumbs ===-->
<div class="row-fluid breadcrumbs margin-bottom-20" style="background: rgb(73, 80, 95);margin-top: -2px">
    <div class="container">
        <h1 class="pull-left" style="color: #ffffff;">手机商城</h1>
    </div><!--/container-->
</div><!--/breadcrumbs-->
<!--=== End Breadcrumbs ===-->
...
<div class="container content">
    ...
    <div class="view row">
        <div class="span12" style="text-align:center;">
            <a href="javascript:void(0);" onclick="javascript:install();"><img src="/Public/Img/Home/ic_launcher.png" class="appicon" onerror="javascript:this.src='http://o1wjx1evz.qnssl.com/static-20160507/assets/img/default-icon.png';" /></a>
            <div>
            </div>
        </div>
    </div>
    ...
    <div id="" class="view row" style="margin-top:30px;">
        ...
        <div class="span12 margin-bottom-20" style="text-align:center;">
            <div class="spinner" >
                <a href="http://www.anumbrella.net/App/AppShopService/Uploads/App/手机商城.apk"  id="down_load"  class="btn-u btn-u-lg"><i class="fa fa-download"></i> 点击下载</a>
            </div>
    ...
    <div id="" class="view row margin-bottom-30">
        <div class="span12" style="text-align:center;">
            或者用手机扫描下面的二维码安装            <br />
            <br />
            <img src="/Public/Img/Home/code.png" style="width:156px; height:156px;" />
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2" style="word-break:break-all;">
            <div class="tag-box tag-box-v6">
                <h2>应用介绍</h2>
                手机商城是一款包括用户注册、登录、密码找回、短信验证、用户分享、消息推送、订单上传、商品分类、商品收藏、购物车订单的增添、删除、商品查询、用户设置、用户评价、用户评论等基本功能的app。 </div>
        </div>
    </div>
                  ...
                  <div class="android-background">
                    <span class="android-inner-img" id="slider_android" >
						<ul>
                                ...
                                <img src="/Public/Img/Home/introduce1.jpg" />
                            </li>
                            <li style="display: none;height: 485px">
                                <img src="/Public/Img/Home/introduce2.jpg" />
                            </li>
                            <li style="display: none;height: 485px">
                                <img src="/Public/Img/Home/introduce3.jpg" />
                            </li>
                            <li style="display: none;height: 485px">
                                <img src="/Public/Img/Home/introduce4.jpg" />
                            </li>
                            <li style="display: none;height: 485px">
                                <img src="/Public/Img/Home/introduce5.jpg" />
                            </li>
                            <li style="display: none;height: 485px">
                                <img src="/Public/Img/Home/introduce6.jpg" />
                            </li>
                            <li style="display: none;height: 485px">
                                <img src="/Public/Img/Home/introduce7.jpg" />
                            </li>
                            <li style="display: none;height: 485px">
                                <img src="/Public/Img/Home/introduce8.jpg" />
                            </li>
                            <li style="display: none;height: 485px">
                                <img src="/Public/Img/Home/introduce9.jpg" />
                            </li>
                            <li style="display: none;height: 485px">
                                <img src="/Public/Img/Home/introduce10.jpg" />
                            </li>
                            <li style="display: none;height: 485px">
                                <img src="/Public/Img/Home/introduce11.jpg" />
                            </li>
                            <li style="display: none;height: 485px">
                                <img src="/Public/Img/Home/introduce12.jpg" />
                            </li>
                            <li style="display: none;height: 485px">
                                <img src="/Public/Img/Home/introduce13.jpg" />
                            </li>
                            <li style="display: none;height: 485px">
                                <img src="/Public/Img/Home/introduce14.jpg" />
                            </li>
                            <li style="display: none;height: 485px">
                                <img src="/Public/Img/Home/introduce15.jpg" />
                            </li>
                            <li style="display: none;height: 485px">
                                <img src="/Public/Img/Home/introduce16.jpg" />
                            </li>
                            <li style="display: none;height: 485px">
                                <img src="/Public/Img/Home/introduce17.jpg" />
                            </li>
                            <li style="display: none;height: 485px">
                                <img src="/Public/Img/Home/introduce18.jpg" />
                            </li>
                        </ul>
                      </span>
                </div>
...
<link rel="stylesheet" href="/Public/Css/Home/custom-sky-forms.css">
...
<script type="Text/Javascript" src="/Public/Js/Home/jquery-1.11.0.min.js"></script>
<script type="text/javascript" src="/Public/Js/Home/jquery.sudoSlider.min.js"></script>
<script>
